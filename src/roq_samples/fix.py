...
@typedispatch
def callback(header: roq.fix.Header, logon: roq.codec.fix.Logon):
    print("logon={}, header={}".format(logon, header))


@typedispatch
def callback(header: roq.fix.Header, logout: roq.codec.fix.Logout):
    print("logout={}, header={}".format(logout, header))


@typedispatch
def callback(header: roq.fix.Header, test_request: roq.codec.fix.TestRequest):
    print("test_request={}, header={}".format(test_request, header))


@typedispatch
def callback(header: roq.fix.Header, heartbeat: roq.codec.fix.Heartbeat):
    print("heartbeat={}, header={}".format(heartbeat, header))


@typedispatch
def callback(header: roq.fix.Header, resend_request: roq.codec.fix.ResendRequest):
    print("resend_request={}, header={}".format(resend_request, header))


@typedispatch
def callback(header: roq.fix.Header, reject: roq.codec.fix.Reject):
    print("reject={}, header={}".format(reject, header))


@typedispatch
def callback(header: roq.fix.Header, business_message_reject: roq.codec.fix.BusinessMessageReject):
    print("business_message_reject={}, header={}".format(business_message_reject, header))


@typedispatch
def callback(header: roq.fix.Header, user_request: roq.codec.fix.UserRequest):
    print("user_request={}, header={}".format(user_request, header))


@typedispatch
def callback(header: roq.fix.Header, user_response: roq.codec.fix.UserResponse):
...
@typedispatch
def callback(header: roq.fix.Header, trading_session_status: roq.codec.fix.TradingSessionStatus):
    print("trading_session_status={}, header={}".format(trading_session_status, header))


@typedispatch
def callback(header: roq.fix.Header, security_list_request: roq.codec.fix.SecurityListRequest):
    print("security_list_request={}, header={}".format(security_list_request, header))


@typedispatch
def callback(header: roq.fix.Header, security_list: roq.codec.fix.SecurityList):
...
# @typedispatch
# def callback(header: roq.fix.Header, security_definition: roq.codec.fix.SecurityDefinition):
#     print("security_definition={}, header={}".format(security_definition, header))


# @typedispatch
# def callback(
#     header: roq.fix.Header, security_status_request: roq.codec.fix.SecurityStatusRequest
# ):
#     print("security_status_request={}, header={}".format(security_status_request, header))


# @typedispatch
# def callback(header: roq.fix.Header, security_status: roq.codec.fix.SecurityStatus):
#     print("security_status={}, header={}".format(security_status, header))


# @typedispatch
# def callback(header: roq.fix.Header, market_data_request: roq.codec.fix.MarketDataRequest):
#     print("market_data_request={}, header={}".format(market_data_request, header))


# @typedispatch
# def callback(
#     header: roq.fix.Header, market_data_request_reject: roq.codec.fix.MarketDataRequestReject
# ):
...
# @typedispatch
# def callback(header: roq.fix.Header, order_status_request: roq.codec.fix.OrderStatusRequest):
#     print("order_status_request={}, header={}".format(order_status_request, header))


# @typedispatch
# def callback(
#     header: roq.fix.Header, order_mass_status_request: roq.codec.fix.OrderMassStatusRequest
# ):
#     print("order_mass_status_request={}, header={}".format(order_mass_status_request, header))


# @typedispatch
# def callback(header: roq.fix.Header, new_order_single: roq.codec.fix.NewOrderSingle):
#     print("new_order_single={}, header={}".format(new_order_single, header))


# @typedispatch
# def callback(header: roq.fix.Header, order_cancel_request: roq.codec.fix.OrderCancelRequest):
...
# @typedispatch
# def callback(
#     header: roq.fix.Header, order_mass_cancel_request: roq.codec.fix.OrderMassCancelRequest
# ):
#     print("order_mass_cancel_request={}, header={}".format(order_mass_cancel_request, header))


# @typedispatch
# def callback(header: roq.fix.Header, order_cancel_reject: roq.codec.fix.OrderCancelReject):
#     print("order_cancel_reject={}, header={}".format(order_cancel_reject, header))


# @typedispatch
# def callback(header: roq.fix.Header, execution_report: roq.codec.fix.ExecutionReport):
...
# @typedispatch
# def callback(header: roq.fix.Header, trade_capture_report: roq.codec.fix.TradeCaptureReport):
#     print("trade_capture_report={}, header={}".format(trade_capture_report, header))


# @typedispatch
# def callback(
#     header: roq.fix.Header, request_for_positions: roq.codec.fix.RequestForPositions
# ):
...
# @typedispatch
# def callback(
#     header: roq.fix.Header, request_for_positions_ack: roq.codec.fix.RequestForPositionsAck
# ):
#     print("request_for_positions_ack={}, header={}".format(request_for_positions_ack, header))


# @typedispatch
# def callback(header: roq.fix.Header, position_report: roq.codec.fix.PositionReport):
